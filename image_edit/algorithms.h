...
void image_convolution_bw(
    unsigned char ***image_in, unsigned char ***image_out, double **w, int size, double factor, double bias
    );

/* Image Convolution with 2 mask, X-Axis and Y-Axis */
void image_convolution_2d_bw(
    unsigned char ***image_in, unsigned char ***image_out, double **wx, double **wy, int size, double factor, double bias
    );
